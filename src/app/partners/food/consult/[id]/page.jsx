...
import { FaPhone, FaMapMarkerAlt, FaEnvelope, FaArrowLeft, FaUtensils, FaStore, FaCheckCircle } from "react-icons/fa";
import useAuthStore from "@/store/authStore";

export default function FoodConsultPage() {
  const { id } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isAuthenticated) {
      ...
      router.push(`/login?redirect=/partners/food/consult/${id}`);
      return;
    }
    ...
    try {
      ...
      sessionStorage.setItem('foodConsultationData', JSON.stringify(sessionData));
      
      toast.success("Consultation request submitted successfully!");
      
      // Redirect to payment page
      router.push(`/partners/food/payment/${id}`);
    } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">Fill out the form below to request a consultation or place an order</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="5"
                    className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none resize-none"
                    placeholder="Tell us about your requirements, dietary preferences, or any special requests..."
                  />
                </div>
